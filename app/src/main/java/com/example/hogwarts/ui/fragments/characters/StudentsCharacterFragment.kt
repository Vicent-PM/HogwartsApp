...
import com.example.hogwarts.databinding.FragmentStudentscharactersBinding
import com.example.hogwarts.ui.MyViewModel

class StudentsCharacterFragment: Fragment() {

    private var _binding: FragmentStudentscharactersBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentStudentscharactersBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        myViewModel.studentsCharactersLiveData.observe(viewLifecycleOwner) {
            listAdapter.update(it)
        }

        myViewModel.getSudentsCharacters()
    }
